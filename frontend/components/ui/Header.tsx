        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            {showBackButton && (
              <Link
                href={backHref}
                className={cn("p-2 rounded-lg transition-all duration-200 group",
                  tinted 
                    ? "bg-white/20 hover:bg-white/30 text-foreground": "bg-muted hover:bg-muted/80 text-foreground")}
              >
            ...
            <div>
              ...
              {subtitle && (
                <motion.p 
                  ...
                  className={cn("text-lg mt-2 text-foreground")}
                >
                  {subtitle}
                </motion.p>
              )}
